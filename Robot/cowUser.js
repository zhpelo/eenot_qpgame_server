	...
	this.initNetWork = function(){
    	...
    	this._socket.on('loginResult',function(result){
    		...
    		self._sign = result.Obj.sign;
	      	...
	      	console.log(self._userId + "进入牛牛游戏");
	    ...
	    this._socket.on('ServerListResult',function(msg){
	    	...
	    	var idx = 0;
	        self._ip = msg.GameInfo[5].serverInfo.normal[idx].ip;
	        self._port = msg.GameInfo[5].serverInfo.normal[idx].prot;
