...
exports.addMatch = function addMatch(Info,serverId){
	var sql = "INSERT INTO matchlog(open11,open12,open13,open14,open15,open21,open22,open23,open24,open25,open31,open32,open33,open34,open35,open41,open42,open43,open44,open45,open2winbet,open3winbet,open4winbet,serveId) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
	var values = [];
	for(var i = 0 ; i < 20 ;i ++){
