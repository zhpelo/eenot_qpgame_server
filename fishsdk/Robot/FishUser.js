	...
	this.initNetWork = function(){
	    ...
	    this._socket.on('ServerListResult',function(msg){
	    	...
	    	if (self._matchRoot){
		    	...
		    	var idx = 0;
		    	if (self._socre < 500000){
		    		idx = 0;
		    	}else if (self._socre >= 500000 && self._socre < 2000000){
		    		idx = 1;
		    	}else if (self._socre >= 2000000 && self._socre < 9000000){
		    		idx = 2;
		    	}else if (self._socre >= 9000000 && self._socre < 20000000){
		    		idx = 3;
		    	}else if (self._socre >= 20000000 && self._socre < 50000000){
		    		idx = 4;
		    	}else if(self._socre >= 50000000){
		    		idx = 5;
		    	}
		    	console.log(self._userId + "进入" + parseInt(idx + 1) +"倍房间!");
		        self._ip = msg.GameInfo[0].serverInfo.normal[idx].ip;
		        self._port = msg.GameInfo[0].serverInfo.normal[idx].prot;
		        //self._ip = msg.GameInfo.serverInfo.normal[idx].ip;
		        //self._port = msg.GameInfo.serverInfo.normal[idx].prot;
	    	}
