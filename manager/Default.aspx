...
<body>
    ...
    <div>
        ...
        <asp:Button ID="Button18" runat="server" Text="注册+ml" OnClick="Button18_Click" />
        ...
        <asp:Button ID="Button13" runat="server" Text="获取用户" OnClick="Button13_Click" />
        <asp:Button ID="Button14" runat="server" Text="购买" OnClick="Button14_Click" />
        <asp:Button ID="Button15" runat="server" Text="test" OnClick="Button15_Click" />
        <asp:Button ID="Button16" runat="server" Text="注册api" OnClick="Button16_Click" />
        <asp:Button ID="Button17" runat="server" Text="wap" OnClick="Button17_Click" />
